    ...
    <div className="balance-container">
      ...
      <header data-thq="thq-navbar" className="balance-navbar">
        ...
        <div
          ...
          data-role="Nav"
          className="balance-desktop-menu"
        ></div>
        ...
        <div data-thq="thq-mobile-menu" className="balance-mobile-menu">
          <div
            data-thq="thq-mobile-menu-nav"
            data-role="Nav"
            className="balance-nav"
          >
            <div className="balance-container01">
              <span className="balance-logo1">Character</span>
              <div data-thq="thq-close-menu" className="balance-menu-close">
                <svg viewBox="0 0 1024 1024" className="balance-icon02">
            ...
            <nav
              ...
              data-role="Nav"
              className="balance-nav1"
            >
              <span className="balance-text">About</span>
              <span className="balance-text01">Features</span>
              <span className="balance-text02">Pricing</span>
              <span className="balance-text03">Team</span>
              <span className="balance-text04">Blog</span>
            </nav>
            <div className="balance-container02">
              <button className="balance-login button">Login</button>
              <button className="button">Register</button>
            </div>
          </div>
          <div className="balance-icon-group">
            <svg
              viewBox="0 0 950.8571428571428 1024"
              className="balance-icon04"
            >
