    ...
    return (
      <div className="home-container">
        <Helmet>
          ...
          <meta property="og:title" content="WealthStrategists" />
        </Helmet>
        <header data-thq="thq-navbar" className="home-navbar">
          <span className="home-logo">WealthStrategists</span>
          <div
        ...
        <section className="home-hero">
          <div className="home-heading">
            <h1 className="home-header">Yield earnings made easy</h1>
          </div>
          <div className="home-stat">
            <h1 className="home-text5">15%</h1>
            <span className="home-text6">YTD</span>
          </div>
          <div className="home-container3">
            ...
            <FeatureCard6 rootClassName="feature-card6-root-class-name"></FeatureCard6>
            <FeatureCard8 rootClassName="feature-card8-root-class-name"></FeatureCard8>
            <FeatureCard4 rootClassName="feature-card4-root-class-name"></FeatureCard4>
            <FeatureCard5 rootClassName="feature-card5-root-class-name"></FeatureCard5>
            <FeatureCard7 rootClassName="feature-card7-root-class-name"></FeatureCard7>
          </div>
          <h1 className="home-text7">
            Let professionals build your strategy and HODL your keys
          </h1>
          <h1 className="home-text8">Become your own hero, be a top player!</h1>
          <footer className="home-footer">
            <span className="home-copyright">
              © 2023 WealthStrategists. All Rights Reserved.
            </span>
          </footer>
